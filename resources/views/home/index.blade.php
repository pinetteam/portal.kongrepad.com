    ...
    <html class="h-100">
        ...
        <body class="bg-dark h-100 align-items-center overflow-scroll">
                                ...
                                <div class="row row-cols-1 row-cols-xs-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 column-gap-0 row-gap-5">
                                    <div class="col">
                                        <div class="card bg-dark border-dark shadow-lg rounded-4 mt-5 p-4 overflow-hidden">
                                            <div class="card-body">
                                                <img class="img-fluid" src="{{ asset('images/kongrepad-icon.png') }}">
                                                <hr/>
                                                <h1 class="text-center text-white">KongrePad'i İndirin</h1>
                                                <img class="img-fluid" src="{{ asset('images/app-store-badge.svg') }}">
                                                <img class="img-fluid" src="{{ asset('images/google-play-badge.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
