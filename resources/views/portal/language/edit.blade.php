...
@section('title', __('common.edit') . ' ' . $language->name)
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('common.edit') . ' ' . $language->name }}</li>
@endsection
...
<div class="modern-hero-card">
    <div class="hero-content">
        ...
        <div class="hero-text">
            <h1 style="color: white; margin-bottom: 0.5rem; font-size: 2rem; font-weight: 700;">{{ __('common.edit-language') }}</h1>
            <p style="color: rgba(255,255,255,0.9); margin: 0; font-size: 1.1rem;">{{ __('common.edit-language-details') }}</p>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="modern-main-card">
            ...
            <div class="card-body">
                <form action="{{ route('portal.language.update', $language->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input type="checkbox" name="is_active" id="is_active" class="form-check-input" {{ old('is_active', $language->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input type="checkbox" name="is_default" id="is_default" class="form-check-input" {{ old('is_default', $language->is_default) ? 'checked' : '' }}>
                            <label for="is_default" class="form-check-label">{{ __('common.default') }}</label>
                        </div>
                        <div class="form-text">{{ __('common.default-language-will-be-used-as-fallback') }}</div>
                    </div>
