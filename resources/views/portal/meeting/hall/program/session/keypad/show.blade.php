                                    ...
                                    <td class="text-end">
                                        <div class="btn-group" role="group" aria-label="{{ __('common.processes') }}">
                                            <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="kp-tooltip" data-bs-title="{{ __('common.edit')}}">
                                                <button class="btn btn-warning btn-sm" title="{{ __('common.edit') }}" data-bs-toggle="modal" data-bs-target="#option-edit-modal" data-route="{{ route('portal.meeting.hall.program.session.keypad.option.update', ['meeting'=>$keypad->session->program->hall->meeting_id, 'hall'=>$keypad->session->program->hall_id, 'program'=>$keypad->session->program_id, 'session'=> $keypad->session->id, 'keypad' => $keypad->id, 'option' => $option->id]) }}" data-resource="{{ route('portal.meeting.hall.program.session.keypad.option.edit', ['meeting'=>$keypad->session->program->hall->meeting_id, 'hall'=>$keypad->session->program->hall_id, 'program'=>$keypad->session->program_id, 'session'=> $keypad->session->id, 'keypad' => $keypad->id, 'option' => $option->id]) }}" data-id="{{ $option->id }}">
