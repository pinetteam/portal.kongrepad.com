...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-white"><a href="{{ route('portal.meeting.show', $screen->hall->meeting->id) }}" class="text-decoration-none text-white">{{ $screen->hall->meeting->title }}</a></li>
    ...
    <li class="breadcrumb-item text-white"><a href="{{ route('portal.meeting.hall.show', ['meeting' => $screen->hall->meeting->id, 'hall' => $screen->hall->id]) }}" class="text-decoration-none text-white">{{ $screen->hall->title }}</a></li>
    <li class="breadcrumb-item text-white"><a href="{{ route('portal.meeting.hall.screen.index', ['meeting' => $screen->hall->meeting->id, 'hall' => $screen->hall->id]) }}" class="text-decoration-none text-white">{{ __('common.screens') }}</a></li>
    <li class="breadcrumb-item active text-white text-decoration-underline" aria-current="page">{{ $screen->title }}</li>
@endsection
