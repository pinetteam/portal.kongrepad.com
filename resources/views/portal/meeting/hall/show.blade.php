                ...
                <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-end" rowspan="1">
                                <div class="btn-group" role="group" aria-label="{{ __('common.processes') }}">
                                    @if($program->type == "session")
                                        <div data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <button type="button"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#session-{{$program->id}}-create-modal"
                                    ...
                                    @endif
                                    <a class="btn btn-info btn-sm" href="{{ route('portal.meeting.hall.program.show', ['meeting' => $meeting->id, 'hall' => $hall->id, 'program' => $program->id]) }}" title="{{ __('common.show') }}" data-bs-toggle="tooltip"
                    ...
                    <x-crud.form.common.edit name="session" method="e-s">
                        @section('session-edit-form')
                            ...
                            <x-input.text method="e-s" name="description" title="description" icon="comment-dots" /><x-input.datetime method="e-s" name="start_at" title="start-at" icon="calendar-arrow-down" />
