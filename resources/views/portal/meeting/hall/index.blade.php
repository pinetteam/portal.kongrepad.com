...
@section('body')
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="btn-group" role="group" aria-label="{{ __('common.processes') }}">
                                        <a class="btn btn-info btn-sm" href="{{ route('portal.meeting.hall.show', ['meeting' => $hall->meeting->id, 'hall' => $hall->id]) }}" title="{{ __('common.show') }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="kp-tooltip" data-bs-title="{{ __('common.show') }}">
    ...
    <x-crud.form.common.create>
        @section('default-create-form')
            <x-input.hidden method="c" name="meeting_id" :value="$hall->meeting->id" />
    ...
    <x-crud.form.common.edit>
        @section('default-edit-form')
            <x-input.hidden method="e" name="meeting_id" :value="$hall->meeting->id" />
