...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-white"><a href="{{ route('portal.meeting.show', $score_game->meeting->id) }}" class="text-decoration-none">{{ $score_game->meeting->title }}</a></li>
    <li class="breadcrumb-item text-white"><a href="{{ route('portal.meeting.report.score-game.index', ['meeting' => $score_game->meeting->id]) }}" class="text-decoration-none">{{ __('common.score-game-reports') }}</a></li>
