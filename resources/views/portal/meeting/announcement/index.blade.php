...
@section('meeting_content')
    <div class="card bg-kongre-secondary">
        <div class="card-header">
            <h1 class="m-0 text-center"><span class="fa-duotone fa-megaphone fa-fade"></span> {{ __('common.announcements') }}</h1>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="btn-group" role="group" aria-label="{{ __('common.processes') }}">
                                        <a class="btn btn-kongre-accent btn-sm" href="{{ route('portal.meeting.announcement.show', ['meeting' => $announcement->meeting->id, 'announcement' => $announcement->id]) }}" title="{{ __('common.show') }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="kp-tooltip" data-bs-title="{{ __('common.show') }}">
                                        ...
                                        <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="kp-tooltip" data-bs-title="{{ __('common.delete') }}">
                                            <button class="btn btn-danger btn-sm" title="{{ __('common.delete') }}" data-bs-toggle="offcanvas" data-bs-target="#announcement-delete-modal" data-route="{{ route('portal.meeting.announcement.destroy', ['meeting' => $announcement->meeting->id, 'announcement' => $announcement->id]) }}" data-record="{{ $announcement->title }}">
        ...
        <div class="card-footer d-flex justify-content-center">
            <button type="button" class="btn btn-success btn-lg w-100" data-bs-toggle="offcanvas" data-bs-target="#announcement-create-modal" data-route="{{ route('portal.meeting.announcement.store', ['meeting' => $meeting->id]) }}">
