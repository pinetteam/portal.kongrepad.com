...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-white"><a href="{{ route('portal.meeting.announcement.index', ['meeting' => $meeting->id]) }}" class="text-decoration-none">{{ __('common.announcements') }}</a></li>
    <li class="breadcrumb-item active text-white" aria-current="page">{{ $announcement->title }}</li>
@endsection
@section('body')
