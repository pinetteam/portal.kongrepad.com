                                                ...
                                                <td colspan="5">
                                                    <div class="table-responsive">
                                                        <table
                                                            ...
                                                            <tr>
                                                                <th scope="col"><span
                                                                        class="fa-regular fa-messages-question mx-1"></span> {{ __('common.option-title') }}
                                                                </th>
                                                                <th scope="col"><span
                                                                        class="fa-regular fa-circle-sort mx-1"></span> {{ __('common.sort-order') }}
                                                                </th>
                                                                        ...
                                                                        <div class="btn-group" role="group"
                                                                            ...
                                                                            <div data-bs-toggle="tooltip"
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    data-route="{{ route('portal.survey-option.show', ['meeting'=>$option->question->survey->meeting_id, 'survey_id'=> $option->question->survey_id,'question_id'=> $option->question_id, 'survey_option'=>$option->id,]) }}"
