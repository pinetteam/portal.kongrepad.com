...
@section('body')
    ...
    <x-crud.form.common.create>
        @section('create-form')
            ...
            <x-input.radio method="c" name="sharing_via_email" title="sharing-via-email" :options="$sharing_via_email_options" option_value="value" option_name="title" icon="envelope" />
