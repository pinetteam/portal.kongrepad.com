                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="btn-group" role="group" aria-label="{{ __('common.processes') }}">
                                    ...
                                    <a class="btn btn-info btn-sm" href="{{ route("portal.debate-report.debate.chart",['debate_id'=>$debate->id]) }}" title="{{ __('common.results') }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="kp-tooltip" data-bs-title="{{ __('common.results') }} ">
