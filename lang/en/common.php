...
return [
    ...
    */
    ...
    'thanks_to_the_qr_code_scanning_system_attendance_a' => 'Thanks to the QR code scanning system, attendance at the session can be made and attendance can be seen. Thanks to the log system, user movements, keypad and debate participation and sessions can be reported. Surveys can be conducted and detailed survey reports can be obtained.',
    'reports2' => 'Reports',
