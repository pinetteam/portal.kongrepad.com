...
class ParticipantController extends Controller
{
    ...
    public function show(int $meeting, int $id)
    {
        ...
        $logs = \App\Models\Log\Meeting\Participant\Participant::where('participant_id', $participant->id)->orderBy('id', 'DESC')->whereNot('action', 'get-participant')->whereNot('action', 'get-meeting')->whereNot('action', 'get-active-session')->whereNot('action', 'get-survey')->whereNot('action', 'get-survey-questions')->whereNot('action', 'get-hall')->get();
