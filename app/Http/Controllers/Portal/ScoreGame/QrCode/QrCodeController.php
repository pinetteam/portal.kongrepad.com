...
namespace App\Http\Controllers\Portal\ScoreGame\QrCode;

use App\Http\Controllers\Controller;
use App\Http\Requests\Portal\ScoreGame\QrCode\QrCodeRequest;
use App\Http\Resources\Portal\ScoreGame\QrCode\QrCodeResource;
...
class QrCodeController extends Controller
{
    ...
    public function store(QrCodeRequest $request)
    {
        if ($request->validated()) {
            ...
            $qr_code->score = $request->input('score');
